...
#ifdef BATCHSTORELIBSERVER
CBatchStoreLibServer g_BatchStoreLibServer;
#endif
#ifdef LAYOUTSERVER
CLayoutServer g_LayoutServer;
#endif
...
#ifdef BATCHSTORELIBSERVER
    g_BatchStoreLibServer.StartBatchStoreLibServer();
#endif
#ifdef LAYOUTSERVER
    g_LayoutServer.StartLayoutServer();
#endif
...
void CNTService::OnStop()
{
	//此处添加服务被终止代码
#ifdef BATCHSTORELIBSERVER
    g_BatchStoreLibServer.StopBatchStoreLibServer();
#endif
#ifdef LAYOUTSERVER
    g_LayoutServer.StopLayoutServer();
#endif
