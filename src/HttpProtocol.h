...
public:
    ...
    bool setRequestMethod(E_HTTP_METHOD method, E_HTTP_CODE ResCode = HL_HTTP_SUCCESS);
    bool setRequestProperty(string property, string value);
    string GetHttpHead();
    string GetHttpBody(string sHttpRequest);

    bool SetHttpBody(string sBody);
    string GetHTTPMsg();
public:
