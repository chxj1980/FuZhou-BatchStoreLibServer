...
{
    CBatchStoreLibServer BatchStoreLibServer;
    if(!BatchStoreLibServer.StartBatchStoreLibServer())
    {
        printf("****Error: 批量入库服务启动失败, 按任意键退出.");
        getchar();
    }
...
#include "ntservice.h"
#include <iostream>
#define SERVICE_NAME "XSBatchStoreLibServer"
//本地函数定义
